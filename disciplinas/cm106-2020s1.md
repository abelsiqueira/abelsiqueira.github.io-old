...
Teremos dois projetos computacionais nesta disciplina. Um deles será referente a implementações computacionais de métodos de otimização não linear, e a utilização de softwares de prontos importantes.

O outro será sobre o desenvolvimento de um problema prático com modelagem.
